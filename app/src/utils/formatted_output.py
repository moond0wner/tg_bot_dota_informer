...
from ..parsers.account_info import AccountInfo
...
def format_button_result(result: str):
    ...
    for player in result:
        answer[f'account_id: {player["account_id"]}'] = f'{player["personaname"]} — {player["account_id"]}'

    return answer
# nick - 123456789


def format_account_info(account: AccountInfo,
...
def format_general_match_info(match: Dict,
                              locale: TranslatorRunner):
    result = (
